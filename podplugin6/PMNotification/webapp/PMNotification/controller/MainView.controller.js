sap.ui.define([
    ...
    return PluginViewController.extend("company.custom.plugins.PMNotification.PMNotification.controller.MainView", {
        onInit: function () {
        ...
        onResourceValueHelpRequest: function () {
            ...
            if (!this.oresourceVHDia) {
                ...
                this.oresourceVHDia = sap.ui.xmlfragment(
                    "company.custom.plugins.PMNotification.PMNotification.view.fragments.ResourceValueHelpDialog",
                    this
                );
